              ...
              <div class="col-div-10">
                <div class="box-10">
                    <div class="content-box">
                        ...
                        <div class="viewOpt">
                        <button style="border: 3px solid #011A3D;"><a href="application.php">One Time Voluntary Work</button></a>
                        <a href="application_recurring.php"><button>Recurring Voluntary Work</button></a>
                        </div><br><br>
                        ...
                        <script type="text/javascript">
                            ...
                            if(answer.value == "All")
                                ...
                                window.location="application.php?request="+answer.value; 
                            }
                        </script>
                        <br/>
                    ...
                    <?php
                        ...
                        { 
                            $value = $_GET['request'];
                            $query = "SELECT application.id,application.workid, voluntaryWork.id,application.status,voluntaryWork.workTitle, voluntaryWork.workDate, voluntaryWork.workStartTime, voluntaryWork.workEndTime, voluntaryWork.workType,
                            voluntaryWork.workState, voluntaryWork.workCity FROM (application INNER JOIN voluntaryWork ON application.workid = voluntaryWork.id)WHERE application.userid = $userid AND status ='$value' AND voluntaryWork.workType = 'One Time' ORDER BY voluntaryWork.workDate DESC;";
                        }
                        else
                            $query = "SELECT application.id,application.workid, voluntaryWork.id,application.status,voluntaryWork.workTitle, voluntaryWork.workDate, voluntaryWork.workStartTime, voluntaryWork.workEndTime, voluntaryWork.workType,
                            voluntaryWork.workState, voluntaryWork.workCity FROM (application INNER JOIN voluntaryWork ON application.workid = voluntaryWork.id)WHERE application.userid = $userid AND voluntaryWork.workType = 'One Time' ORDER BY voluntaryWork.workDate DESC;";
