...
<html lang="en">
    ...
    ?>
        ...
        <div class="slidebanner-container">
            ...
            <div class="viewOpt">
                <button style="border: 3px solid #011A3D;"><a href="index.html">One Time Voluntary Work</button></a>
                <a href="indexRecurring.php"><button>Recurring Voluntary Work</button></a>
            </div>
            ...
            <div class="row">
                ...
                <?php include 'connection.php';
                    ...
                    {
                        $sql = "SELECT * FROM voluntaryWork WHERE workStatus=1 AND workType = 'One Time'";
                    } 
                    else 
                    {
                        $sql = "SELECT * FROM voluntaryWork WHERE workState='$selected_state' AND workStatus=1 AND workType = 'One Time'";
                    }
