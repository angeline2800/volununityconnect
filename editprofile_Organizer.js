function validateEditForm()
{
    ...
    let oName = document.edit.oName.value;
    let oDes = document.edit.oDes.value;
    ...
    if( oDes  == ""  )
    {
        alert("Description of organization is Required!");
        return false;
    }
...
function ValidatePhone(phone) //Validate phone number
{
    ...
    else if(phone.length> 11 || phone.length < 10) //Too short or too long
    {
...
function display() 
{
    ...
    document.getElementById("display11").style.display = "none";
    ...
    document.getElementById("oDes").style.display = "block";
...
function cancel_edit()
{
    ...
    document.getElementById("display11").style.display = "block";
    ...
    document.getElementById("oDes").style.display = "none";
