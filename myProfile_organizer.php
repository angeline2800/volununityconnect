...
<html>
    <head>
        ...
        <script type="text/javascript" src="editprofile_Organizer.js"></script>
    ...
    <body>
        ...
        <header class="HeaderHeader" id="Push_header">
            ...
            <ul id = abc>
                ...
                <ul>
                  ...
                  <li>&nbsp|&nbsp</li>
                  <li><a href="myProfile_organizer.php"  >My Profile</a></li>
        ...
        <main>
            <?php 
                ...
                if($fnameE === "false" && $lnameE === "false" && $emailE === "false" && $mobileE === "false" && $pwE === "false" && $cpwE === "false" && $addE === "false" && $cityE === "false" && $oNameE === "false" && $oDesE === "false"
                &&  $fname != "" && $lname != "" && $email != "" && $mobile != "" && $pw != "" && $cpw != "" && $add != "" &&  $city != "" && $oName != "" && $oDes != "")
                {

                    //Update the user info in the database table
                    $sql= "UPDATE user
                    SET firstname = '$fname', lastname= '$lname', email= '$email', phone= '$mobile', pwd= '$pw', 
                    gender= '$gender', _state= '$state', _address= '$add', city= '$city', oName= '$oName', oDes= '$oDes'
                    WHERE id = '$id'";
            ...
            <div class = "column">
                ...
                <div class="column2">
                    <form name="edit" method="post" enctype="multipart/form-data" onsubmit="return validateEditForm()" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
                        ...
                        <li id="display8"><?php    echo ": " .$row["oName"].""; ?></li>
                        <li><input type="text" id="oName" name="oName"  value="<?php echo $row["oName"];?>" ></li>

                        <li id="display11"><?php    echo ": " .$row["oDes"].""; ?></li>
                        <li><textarea id="oDes" name="oDes" style="display:none;" ><?php echo $row["oDes"];?></textarea></li>
